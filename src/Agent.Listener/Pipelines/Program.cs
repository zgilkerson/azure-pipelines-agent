...
", replacementContext));
            ...
            // dsBuilder.WithTypeConverter(new StringYamlConverter()); // hack for core clr version
            ...
            var pipelineTemplate = deserializer.Deserialize<PipelineTemplate>(File.ReadAllText(args[1])); //"template.yaml"));
