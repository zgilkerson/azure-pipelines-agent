            ...
            while (parser.Allow<MappingEnd>() == null)
            {
                ...
                switch (scalar.Value ?? String.Empty)
                {
                    ...
                    case PipelineConstants.Template:
                        ...
                        ValidateNull(result.Timeout, PipelineConstants.Timeout, PipelineConstants.Template, scalar);
                    ...
                    case PipelineConstants.Phases:
                        ...
                        ValidateNull(result.Timeout, PipelineConstants.Timeout, PipelineConstants.Phases, scalar);
                    ...
                    case PipelineConstants.Target:
                        ...
                        ValidateNull(result.Timeout, PipelineConstants.Timeout, PipelineConstants.Target, scalar);
                    ...
                    case PipelineConstants.Timeout:
                        ValidateNull(result.Template, PipelineConstants.Template, PipelineConstants.Timeout, scalar);
                        ValidateNull(result.Phases, PipelineConstants.Phases, PipelineConstants.Timeout, scalar);
                        ValidateNull(result.Jobs, PipelineConstants.Jobs, PipelineConstants.Timeout, scalar);
                        result.Timeout = ReadTimespan(parser);
                        break;
    ...
    internal abstract class YamlTypeConverter : IYamlTypeConverter
    {
            ...
            if (String.Equals(scalar.Value, PipelineConstants.Name, StringComparison.Ordinal))
            {
                ...
                while (parser.Allow<MappingEnd>() == null)
                {
                    ...
                    switch (scalar.Value ?? String.Empty)
                    {
                        ...
                        case PipelineConstants.Target:
                            ValidateNull(phase.Timeout, PipelineConstants.Timeout, PipelineConstants.Target, scalar);
                        ...
                        case PipelineConstants.Jobs:
                            ValidateNull(phase.Timeout, PipelineConstants.Timeout, PipelineConstants.Jobs, scalar);
                        ...
                        case PipelineConstants.Timeout:
                            ValidateNull(phase.Jobs, PipelineConstants.Jobs, PipelineConstants.Timeout, scalar);
                            phase.Timeout = ReadTimespan(parser);
                            break;
        ...
        protected IJob ReadJob(IParser parser, Boolean simpleOnly = false)
        {
            ...
            if (String.Equals(scalar.Value, PipelineConstants.Name, StringComparison.Ordinal))
            {
                ...
                while (parser.Allow<MappingEnd>() == null)
                {
                    ...
                    {
                        case PipelineConstants.Timeout:
                            job.Timeout = ReadTimespan(parser);
                            break;
        ...
        protected void WriteJob(IEmitter emitter, IJob job, Boolean noBootstrap = false)
        {
            ...
            else
            {
                ...
                if (j.Timeout != null)
                {
                    emitter.Emit(new Scalar(PipelineConstants.Timeout));
                    emitter.Emit(new Scalar(string.Format(CultureInfo.InvariantCulture, "{0}", j.Timeout)));
                }
        ...
        // protected Dictionary<String, String> ReadMappingOfStringString(IParser parser)
        // {
        //     return ReadMappingOfStringString(parser, StringComparer.OrdinalIgnoreCase);
        // }
        ...
        {
            if (!Object.ReferenceEquals(prevObj, null))
            {
