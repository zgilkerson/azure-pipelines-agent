...
namespace Microsoft.VisualStudio.Services.Agent.Listener.Configuration
{
    ...
    public sealed class ConfigurationManager : AgentService, IConfigurationManager
    {
        ...
        public async Task ConfigureAsync(CommandSettings command)
        {
            ...
            {
                caCert = Path.Combine(Directory.GetCurrentDirectory(), caCert);
                ...
                !string.IsNullOrEmpty(clientCertPassword))
            {
                ...
                clientCert = Path.Combine(Directory.GetCurrentDirectory(), clientCert);
                clientCertKey = Path.Combine(Directory.GetCurrentDirectory(), clientCertKey);
                clientCertArchive = Path.Combine(Directory.GetCurrentDirectory(), clientCertArchive);
